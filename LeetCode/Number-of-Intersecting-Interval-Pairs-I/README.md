...
Can you solve this real interview question? Number of Intersecting Interval Pairs I - You are given a 2D integer array intervals of n elements, where intervals[i] = [starti, endi] represents the closed interval from starti to endi.
