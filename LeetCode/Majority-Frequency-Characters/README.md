...
Can you solve this real interview question? Majority Frequency Characters - You are given a string s consisting of lowercase English letters.
...
Frequency (k) Distinct characters in group Group size Majority? 4 {d} 1 No 3 {a, b} 2 Yes 2 {c} 1 No 1 {e} 1 No
...
Frequency (k) Distinct characters in group Group size Majority? 1 {a, b, c, d} 4 Yes
...
Frequency (k) Distinct characters in group Group size Majority? 2 {p, f} 2 Yes 1 {g, i} 2 No (tied size, lower frequency)
