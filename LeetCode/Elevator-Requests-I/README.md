...
Can you solve this real interview question? Elevator Requests I - You are given an integer n denoting the number of floors in a building, where the floors are numbered from 0 to n - 1.
